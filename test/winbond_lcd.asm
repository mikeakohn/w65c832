...
;; This is the same as lcd.asm, but runs from memory location 0xc000 from
;; the Winbond W25Q128JV flash chip.
...
;; Put colors on an another page to test the speed of paging.
.org 0x10000
